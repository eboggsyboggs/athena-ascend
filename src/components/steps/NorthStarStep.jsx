              ...
              {visionSuggestions.map((suggestion, idx) => {
                ...
                return (
                  <button
                    ...
                    className="px-3 py-1.5 text-sm bg-purple-50 text-purple-700 rounded-full border border-purple-200 hover:bg-purple-100 transition-all flex items-center gap-1.5"
                  >
